...
<html lang="en">
   ...
   <head>
      ...
      <!-- CSS==================================================-->
      <link rel="stylesheet" href="{{ url('front/plugins/css/plugins.css')}}">
      ...
      <div class="wrapper">
         <nav class="navbar navbar-default navbar-fixed navbar-transparent white bootsnav">
            <div class="container">
               ...
               <div class="navbar-header"><a class="navbar-brand" href="index-2.html"><img src="{{url('front/img/logo-white.png')}}"
                  class="logo logo-display"
                  alt=""><img
                  src="{{url('front/img/logo-white.png')}}" class="logo logo-scrolled" alt=""></a></div>
               <div class="collapse navbar-collapse" id="navbar-menu">
                  <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                     ...
                     <li class="left-br"><a href="{{url('admin/login')}}" class="signin">Sign In Now</a></li>
                  </ul>
                  <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
         ...
         <div class="banner" style="background-image:url(front/img/banner-9.jpg);">
            <div class="container">
            ...
            <div class="company-brand">
               <div class="container">
                  <div id="company-brands" class="owl-carousel">
                     <div class="brand-img"><img src="{{url('front/img/microsoft-home.png')}}" class="img-responsive" alt=""/>
                     </div>
                     <div class="brand-img"><img src="{{url('front/img/img-home.png')}}" class="img-responsive" alt=""/></div>
                     <div class="brand-img"><img src="{{url('front/img/mothercare-home.png')}}" class="img-responsive" alt=""/>
                     </div>
                     <div class="brand-img"><img src="{{url('front/img/paypal-home.png')}}" class="img-responsive" alt=""/></div>
                     <div class="brand-img"><img src="{{url('front/img/serv-home.png')}}" class="img-responsive" alt=""/></div>
                     <div class="brand-img"><img src="{{url('front/img/xerox-home.png')}}" class="img-responsive" alt=""/></div>
                     <div class="brand-img"><img src="{{url('front/img/yahoo-home.png')}}" class="img-responsive" alt=""/></div>
                     <div class="brand-img"><img src="{{url('front/img/mothercare-home.png')}}" class="img-responsive" alt=""/>
                     </div>
                  </div>
               </div>
               ...
               <div class="row extra-mrg">
                  <div class="col-md-3 col-sm-6">
                     <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="{{url('front/img/com-1.jpg')}}" class="img-responsive"
                           alt=""/></div>
                  ...
                  <div class="col-md-3 col-sm-6">
                     <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="{{url('front/img/com-2.jpg')}}" class="img-responsive"
                           alt=""/></div>
                        <div class="brows-job-position">
                           <h3><a href="job-detail.html">Web Developer</a></h3>
                           <p><span>Google</span></p>
                  ...
                  <div class="col-md-3 col-sm-6">
                     <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="{{url('front/img/com-3.jpg')}}" class="img-responsive"
                           alt=""/></div>
                        <div class="brows-job-position">
                           <h3><a href="job-detail.html">Web Developer</a></h3>
                           <p><span>Google</span></p>
                  ...
                  <div class="col-md-3 col-sm-6">
                     <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="{{url('front/img/com-4.jpg')}}" class="img-responsive"
                           alt=""/></div>
                        <div class="brows-job-position">
                           <h3><a href="job-detail.html">Web Developer</a></h3>
                           <p><span>Google</span></p>
                  ...
                  <div class="col-md-3 col-sm-6">
                     <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="{{url('front/img/com-5.jpg')}}" class="img-responsive"
                           alt=""/></div>
                        <div class="brows-job-position">
                           <h3><a href="job-detail.html">Web Developer</a></h3>
                           <p><span>Google</span></p>
                  ...
                  <div class="col-md-3 col-sm-6">
                     <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="{{url('front/img/com-6.jpg')}}" class="img-responsive"
                           alt=""/></div>
                        <div class="brows-job-position">
                           <h3><a href="job-detail.html">Web Developer</a></h3>
                           <p><span>Google</span></p>
                  ...
                  <div class="col-md-3 col-sm-6">
                     <div class="grid-view brows-job-list">
                        <div class="brows-job-company-img"><img src="{{url('front/img/com-7.jpg')}}" class="img-responsive"
                           alt=""/></div>
                        <div class="brows-job-position">
                           <h3><a href="job-detail.html">Web Developer</a></h3>
                           <p><span>Google</span></p>
         ...
         <div class="clearfix"></div>
         <section class="video-sec dark" id="video" style="background-image:url(front/img/banner-10.jpg);">
            <div class="container">
               <div class="row">
                  <div class="main-heading">
               ...
               <div class="row">
                  <div class="col-md-4 col-sm-4">
                     <div class="working-process">
                        <span class="process-img"><img src="{{url('front/img/step-1.png')}}" class="img-responsive" alt=""/><span
                  ...
                  <div class="col-md-4 col-sm-4">
                     <div class="working-process">
                        <span class="process-img"><img src="{{url('front/img/step-2.png')}}" class="img-responsive" alt=""/><span
                  ...
                  <div class="col-md-4 col-sm-4">
                     <div class="working-process">
                        <span class="process-img"><img src="{{url('front/img/step-3.png')}}" class="img-responsive" alt=""/><span
               ...
               <div class="row">
                  <div id="client-testimonial-slider" class="owl-carousel">
                     <div class="client-testimonial">
                        <div class="pic"><img src="{{url('front/img/client-1.jpg')}}" alt=""></div>
                     ...
                     <div class="client-testimonial">
                        <div class="pic"><img src="{{url('front/img/client-2.jpg')}}" alt=""></div>
                        <p class="client-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                           eiusmod tempor et dolore magna aliqua.
                        </p>
                     ...
                     <div class="client-testimonial">
                        <div class="pic"><img src="{{url('front/img/client-3.jpg')}}" alt=""></div>
                        <p class="client-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
                           eiusmod tempor et dolore magna aliqua.
                        </p>
                     ...
                     <div class="freelance-container style-2">
                        <div class="freelance-box">
                           ...
                           <div class="freelance-inner-box">
                              <div class="freelance-box-thumb"><img src="{{url('front/img/can-5.jpg')}}"
         ...
         <section class="download-app" style="background-image:url(front/img/banner-7.jpg);">
            <div class="container">
               <div class="col-md-5 col-sm-5 hidden-xs"><img src="{{url('front/img/iphone.png')}}" alt="iphone"
         ...
         <footer class="footer">
            <div class="row lg-menu">
               <div class="container">
                  <div class="col-md-4 col-sm-4"><img src="{{url('front/img/footer-logo.png')}}" class="img-responsive" alt=""/>
                  </div>
                     ...
                     <div class="tab" role="tabpanel">
                        ...
                        <div class="tab-content" id="myModalLabel2">
                           <div role="tabpanel" class="tab-pane fade in active" id="login">
                              <img src="{{url('front/img/logo.png')}}" class="img-responsive" alt=""/>
